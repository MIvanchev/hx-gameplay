...
mkdir -p ../../android-arm7/out || error_cd "failed to create output directory"
cp libgame-7.so ../../android-arm7/out/libgame.so || cp libgame-debug-7.so ../../android-arm7/out/libgame-debug.so || error_cd "failed to copy application shared object"
cd ../../..
