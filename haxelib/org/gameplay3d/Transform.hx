...
class Transform extends AnimationTarget_ScriptTarget
{
    ...
    static var hx_Transform_Construct = cpp.Lib.load("gameplay", "hx_Transform_Construct", 0);
    static var hx_Transform_Construct_Trans = cpp.Lib.load("gameplay", "hx_Transform_Construct_Trans", 1);
    static var hx_Transform_Construct_V3_Mat_V3 = cpp.Lib.load("gameplay", "hx_Transform_Construct_V3_Mat_V3", 3);
    static var hx_Transform_Construct_V3_Qtrn_V3 = cpp.Lib.load("gameplay", "hx_Transform_Construct_V3_Qtrn_V3", 3);
    static var hx_Transform_addListener = cpp.Lib.load("gameplay", "hx_Transform_addListener", 3);
    static var hx_Transform_getAnimationPropertyComponentCount = cpp.Lib.load("gameplay", "hx_Transform_getAnimationPropertyComponentCount", 2);
    static var hx_Transform_getAnimationPropertyValue = cpp.Lib.load("gameplay", "hx_Transform_getAnimationPropertyValue", 3);
    static var hx_Transform_getBackVector = cpp.Lib.load("gameplay", "hx_Transform_getBackVector", 1);
    static var hx_Transform_getBackVector_V3 = cpp.Lib.load("gameplay", "hx_Transform_getBackVector_V3", 2);
    static var hx_Transform_getDownVector = cpp.Lib.load("gameplay", "hx_Transform_getDownVector", 1);
    static var hx_Transform_getDownVector_V3 = cpp.Lib.load("gameplay", "hx_Transform_getDownVector_V3", 2);
    static var hx_Transform_getForwardVector = cpp.Lib.load("gameplay", "hx_Transform_getForwardVector", 1);
    static var hx_Transform_getForwardVector_V3 = cpp.Lib.load("gameplay", "hx_Transform_getForwardVector_V3", 2);
    static var hx_Transform_getLeftVector = cpp.Lib.load("gameplay", "hx_Transform_getLeftVector", 1);
    static var hx_Transform_getLeftVector_V3 = cpp.Lib.load("gameplay", "hx_Transform_getLeftVector_V3", 2);
    static var hx_Transform_getMatrix = cpp.Lib.load("gameplay", "hx_Transform_getMatrix", 1);
    static var hx_Transform_getRightVector = cpp.Lib.load("gameplay", "hx_Transform_getRightVector", 1);
    static var hx_Transform_getRightVector_V3 = cpp.Lib.load("gameplay", "hx_Transform_getRightVector_V3", 2);
    static var hx_Transform_getRotation = cpp.Lib.load("gameplay", "hx_Transform_getRotation", 1);
    static var hx_Transform_getRotation_V3 = cpp.Lib.load("gameplay", "hx_Transform_getRotation_V3", 2);
    static var hx_Transform_getRotation_Mat = cpp.Lib.load("gameplay", "hx_Transform_getRotation_Mat", 2);
    static var hx_Transform_getRotation_Qtrn = cpp.Lib.load("gameplay", "hx_Transform_getRotation_Qtrn", 2);
    static var hx_Transform_getScale = cpp.Lib.load("gameplay", "hx_Transform_getScale", 1);
    static var hx_Transform_getScale_V3 = cpp.Lib.load("gameplay", "hx_Transform_getScale_V3", 2);
    static var hx_Transform_getScaleX = cpp.Lib.load("gameplay", "hx_Transform_getScaleX", 1);
    static var hx_Transform_getScaleY = cpp.Lib.load("gameplay", "hx_Transform_getScaleY", 1);
    static var hx_Transform_getScaleZ = cpp.Lib.load("gameplay", "hx_Transform_getScaleZ", 1);
    static var hx_Transform_getTranslation = cpp.Lib.load("gameplay", "hx_Transform_getTranslation", 1);
    static var hx_Transform_getTranslation_V3 = cpp.Lib.load("gameplay", "hx_Transform_getTranslation_V3", 2);
    static var hx_Transform_getTranslationX = cpp.Lib.load("gameplay", "hx_Transform_getTranslationX", 1);
    static var hx_Transform_getTranslationY = cpp.Lib.load("gameplay", "hx_Transform_getTranslationY", 1);
    static var hx_Transform_getTranslationZ = cpp.Lib.load("gameplay", "hx_Transform_getTranslationZ", 1);
    static var hx_Transform_getUpVector = cpp.Lib.load("gameplay", "hx_Transform_getUpVector", 1);
    static var hx_Transform_getUpVector_V3 = cpp.Lib.load("gameplay", "hx_Transform_getUpVector_V3", 2);
    static var hx_Transform_static_isTransformChangedSuspended = cpp.Lib.load("gameplay", "hx_Transform_static_isTransformChangedSuspended", 0);
    static var hx_Transform_removeListener = cpp.Lib.load("gameplay", "hx_Transform_removeListener", 2);
    static var hx_Transform_static_resumeTransformChanged = cpp.Lib.load("gameplay", "hx_Transform_static_resumeTransformChanged", 0);
    static var hx_Transform_rotate_Mat = cpp.Lib.load("gameplay", "hx_Transform_rotate_Mat", 2);
    static var hx_Transform_rotate_Qtrn = cpp.Lib.load("gameplay", "hx_Transform_rotate_Qtrn", 2);
    static var hx_Transform_rotate_V3_Flt = cpp.Lib.load("gameplay", "hx_Transform_rotate_V3_Flt", 3);
    static var hx_Transform_rotate_FltX4 = cpp.Lib.load("gameplay", "hx_Transform_rotate_FltX4", 5);
    static var hx_Transform_rotateX = cpp.Lib.load("gameplay", "hx_Transform_rotateX", 2);
    static var hx_Transform_rotateY = cpp.Lib.load("gameplay", "hx_Transform_rotateY", 2);
    static var hx_Transform_rotateZ = cpp.Lib.load("gameplay", "hx_Transform_rotateZ", 2);
    static var hx_Transform_scale_V3 = cpp.Lib.load("gameplay", "hx_Transform_scale_V3", 2);
    static var hx_Transform_scale_Flt = cpp.Lib.load("gameplay", "hx_Transform_scale_Flt", 2);
    static var hx_Transform_scale_FltX3 = cpp.Lib.load("gameplay", "hx_Transform_scale_FltX3", 4);
    static var hx_Transform_scaleX = cpp.Lib.load("gameplay", "hx_Transform_scaleX", 2);
    static var hx_Transform_scaleY = cpp.Lib.load("gameplay", "hx_Transform_scaleY", 2);
    static var hx_Transform_scaleZ = cpp.Lib.load("gameplay", "hx_Transform_scaleZ", 2);
    static var hx_Transform_set_Trans = cpp.Lib.load("gameplay", "hx_Transform_set_Trans", 2);
    static var hx_Transform_set_V3_Mat_V3 = cpp.Lib.load("gameplay", "hx_Transform_set_V3_Mat_V3", 4);
    static var hx_Transform_set_V3_Qtrn_V3 = cpp.Lib.load("gameplay", "hx_Transform_set_V3_Qtrn_V3", 4);
    static var hx_Transform_set_V3X2_Flt_V3 = cpp.Lib.load("gameplay", "hx_Transform_set_V3X2_Flt_V3", 5);
    static var hx_Transform_setAnimationPropertyValue = cpp.Lib.load("gameplay", "hx_Transform_setAnimationPropertyValue", 4);
    static var hx_Transform_setIdentity = cpp.Lib.load("gameplay", "hx_Transform_setIdentity", 1);
    static var hx_Transform_setRotation_Mat = cpp.Lib.load("gameplay", "hx_Transform_setRotation_Mat", 2);
    static var hx_Transform_setRotation_Qtrn = cpp.Lib.load("gameplay", "hx_Transform_setRotation_Qtrn", 2);
    static var hx_Transform_setRotation_V3_Flt = cpp.Lib.load("gameplay", "hx_Transform_setRotation_V3_Flt", 3);
    static var hx_Transform_setRotation_FltX4 = cpp.Lib.load("gameplay", "hx_Transform_setRotation_FltX4", 5);
    static var hx_Transform_setScale_V3 = cpp.Lib.load("gameplay", "hx_Transform_setScale_V3", 2);
    static var hx_Transform_setScale_Flt = cpp.Lib.load("gameplay", "hx_Transform_setScale_Flt", 2);
    static var hx_Transform_setScale_FltX3 = cpp.Lib.load("gameplay", "hx_Transform_setScale_FltX3", 4);
    static var hx_Transform_setScaleX = cpp.Lib.load("gameplay", "hx_Transform_setScaleX", 2);
    static var hx_Transform_setScaleY = cpp.Lib.load("gameplay", "hx_Transform_setScaleY", 2);
    static var hx_Transform_setScaleZ = cpp.Lib.load("gameplay", "hx_Transform_setScaleZ", 2);
    static var hx_Transform_setTranslation_V3 = cpp.Lib.load("gameplay", "hx_Transform_setTranslation_V3", 2);
    static var hx_Transform_setTranslation_FltX3 = cpp.Lib.load("gameplay", "hx_Transform_setTranslation_FltX3", 4);
    static var hx_Transform_setTranslationX = cpp.Lib.load("gameplay", "hx_Transform_setTranslationX", 2);
    static var hx_Transform_setTranslationY = cpp.Lib.load("gameplay", "hx_Transform_setTranslationY", 2);
    static var hx_Transform_setTranslationZ = cpp.Lib.load("gameplay", "hx_Transform_setTranslationZ", 2);
    static var hx_Transform_static_suspendTransformChanged = cpp.Lib.load("gameplay", "hx_Transform_static_suspendTransformChanged", 0);
    static var hx_Transform_transformPoint_V3 = cpp.Lib.load("gameplay", "hx_Transform_transformPoint_V3", 2);
    static var hx_Transform_transformPoint_V3X2 = cpp.Lib.load("gameplay", "hx_Transform_transformPoint_V3X2", 3);
    static var hx_Transform_transformVector_V3 = cpp.Lib.load("gameplay", "hx_Transform_transformVector_V3", 2);
    static var hx_Transform_transformVector_V3X2 = cpp.Lib.load("gameplay", "hx_Transform_transformVector_V3X2", 3);
    static var hx_Transform_transformVector_FltX4_V3 = cpp.Lib.load("gameplay", "hx_Transform_transformVector_FltX4_V3", -1);
    static var hx_Transform_translate_V3 = cpp.Lib.load("gameplay", "hx_Transform_translate_V3", 2);
    static var hx_Transform_translate_FltX3 = cpp.Lib.load("gameplay", "hx_Transform_translate_FltX3", 4);
    static var hx_Transform_translateForward = cpp.Lib.load("gameplay", "hx_Transform_translateForward", 2);
    static var hx_Transform_translateLeft = cpp.Lib.load("gameplay", "hx_Transform_translateLeft", 2);
    static var hx_Transform_translateSmooth = cpp.Lib.load("gameplay", "hx_Transform_translateSmooth", 4);
    static var hx_Transform_translateUp = cpp.Lib.load("gameplay", "hx_Transform_translateUp", 2);
    static var hx_Transform_translateX = cpp.Lib.load("gameplay", "hx_Transform_translateX", 2);
    static var hx_Transform_translateY = cpp.Lib.load("gameplay", "hx_Transform_translateY", 2);
    static var hx_Transform_translateZ = cpp.Lib.load("gameplay", "hx_Transform_translateZ", 2);
