...
class Node extends Transform, implements Ref
{
    ...
    static var hx_Node_addAdvertisedDescendant = cpp.Lib.load("gameplay", "hx_Node_addAdvertisedDescendant", 2);
    static var hx_Node_addChild = cpp.Lib.load("gameplay", "hx_Node_addChild", 2);
    static var hx_Node_clone = cpp.Lib.load("gameplay", "hx_Node_clone", 1);
    static var hx_Node_static_create = cpp.Lib.load("gameplay", "hx_Node_static_create", 1);
    static var hx_Node_findNode = cpp.Lib.load("gameplay", "hx_Node_findNode", 4);
    static var hx_Node_findNodes = cpp.Lib.load("gameplay", "hx_Node_findNodes", 5);
    static var hx_Node_getActiveCameraTranslationView = cpp.Lib.load("gameplay", "hx_Node_getActiveCameraTranslationView", 1);
    static var hx_Node_getActiveCameraTranslationWorld = cpp.Lib.load("gameplay", "hx_Node_getActiveCameraTranslationWorld", 1);
    static var hx_Node_getAdvertisedDescendant = cpp.Lib.load("gameplay", "hx_Node_getAdvertisedDescendant", 2);
    static var hx_Node_getAgent = cpp.Lib.load("gameplay", "hx_Node_getAgent", 1);
    static var hx_Node_getAnimation = cpp.Lib.load("gameplay", "hx_Node_getAnimation", 2);
    static var hx_Node_getAudioSource = cpp.Lib.load("gameplay", "hx_Node_getAudioSource", 1);
    static var hx_Node_getBoundingSphere = cpp.Lib.load("gameplay", "hx_Node_getBoundingSphere", 1);
    static var hx_Node_getCamera = cpp.Lib.load("gameplay", "hx_Node_getCamera", 1);
    static var hx_Node_getChildCount = cpp.Lib.load("gameplay", "hx_Node_getChildCount", 1);
    static var hx_Node_getCollisionObject = cpp.Lib.load("gameplay", "hx_Node_getCollisionObject", 1);
    static var hx_Node_getFirstChild = cpp.Lib.load("gameplay", "hx_Node_getFirstChild", 1);
    static var hx_Node_getForm = cpp.Lib.load("gameplay", "hx_Node_getForm", 1);
    static var hx_Node_getForwardVectorView = cpp.Lib.load("gameplay", "hx_Node_getForwardVectorView", 1);
    static var hx_Node_getForwardVectorWorld = cpp.Lib.load("gameplay", "hx_Node_getForwardVectorWorld", 1);
    static var hx_Node_getId = cpp.Lib.load("gameplay", "hx_Node_getId", 1);
    static var hx_Node_getInverseTransposeWorldMatrix = cpp.Lib.load("gameplay", "hx_Node_getInverseTransposeWorldMatrix", 1);
    static var hx_Node_getInverseTransposeWorldViewMatrix = cpp.Lib.load("gameplay", "hx_Node_getInverseTransposeWorldViewMatrix", 1);
    static var hx_Node_getInverseViewMatrix = cpp.Lib.load("gameplay", "hx_Node_getInverseViewMatrix", 1);
    static var hx_Node_getInverseViewProjectionMatrix = cpp.Lib.load("gameplay", "hx_Node_getInverseViewProjectionMatrix", 1);
    static var hx_Node_getLight = cpp.Lib.load("gameplay", "hx_Node_getLight", 1);
    static var hx_Node_getModel = cpp.Lib.load("gameplay", "hx_Node_getModel", 1);
    static var hx_Node_getNextSibling = cpp.Lib.load("gameplay", "hx_Node_getNextSibling", 1);
    static var hx_Node_getNumAdvertisedDescendants = cpp.Lib.load("gameplay", "hx_Node_getNumAdvertisedDescendants", 1);
    static var hx_Node_getParent = cpp.Lib.load("gameplay", "hx_Node_getParent", 1);
    static var hx_Node_getParticleEmitter = cpp.Lib.load("gameplay", "hx_Node_getParticleEmitter", 1);
    static var hx_Node_getPreviousSibling = cpp.Lib.load("gameplay", "hx_Node_getPreviousSibling", 1);
    static var hx_Node_getProjectionMatrix = cpp.Lib.load("gameplay", "hx_Node_getProjectionMatrix", 1);
    static var hx_Node_getRightVectorWorld = cpp.Lib.load("gameplay", "hx_Node_getRightVectorWorld", 1);
    static var hx_Node_getRootNode = cpp.Lib.load("gameplay", "hx_Node_getRootNode", 1);
    static var hx_Node_getScene = cpp.Lib.load("gameplay", "hx_Node_getScene", 1);
    static var hx_Node_getTag = cpp.Lib.load("gameplay", "hx_Node_getTag", 2);
    static var hx_Node_getTerrain = cpp.Lib.load("gameplay", "hx_Node_getTerrain", 1);
    static var hx_Node_getTranslationView = cpp.Lib.load("gameplay", "hx_Node_getTranslationView", 1);
    static var hx_Node_getTranslationWorld = cpp.Lib.load("gameplay", "hx_Node_getTranslationWorld", 1);
    static var hx_Node_getType = cpp.Lib.load("gameplay", "hx_Node_getType", 1);
    static var hx_Node_getUpVectorWorld = cpp.Lib.load("gameplay", "hx_Node_getUpVectorWorld", 1);
    static var hx_Node_getUserPointer = cpp.Lib.load("gameplay", "hx_Node_getUserPointer", 1);
    static var hx_Node_getViewMatrix = cpp.Lib.load("gameplay", "hx_Node_getViewMatrix", 1);
    static var hx_Node_getViewProjectionMatrix = cpp.Lib.load("gameplay", "hx_Node_getViewProjectionMatrix", 1);
    static var hx_Node_getWorldMatrix = cpp.Lib.load("gameplay", "hx_Node_getWorldMatrix", 1);
    static var hx_Node_getWorldViewMatrix = cpp.Lib.load("gameplay", "hx_Node_getWorldViewMatrix", 1);
    static var hx_Node_getWorldViewProjectionMatrix = cpp.Lib.load("gameplay", "hx_Node_getWorldViewProjectionMatrix", 1);
    static var hx_Node_hasTag = cpp.Lib.load("gameplay", "hx_Node_hasTag", 2);
    static var hx_Node_removeAllChildren = cpp.Lib.load("gameplay", "hx_Node_removeAllChildren", 1);
    static var hx_Node_removeChild = cpp.Lib.load("gameplay", "hx_Node_removeChild", 2);
    static var hx_Node_setAgent = cpp.Lib.load("gameplay", "hx_Node_setAgent", 2);
    static var hx_Node_setAudioSource = cpp.Lib.load("gameplay", "hx_Node_setAudioSource", 2);
    static var hx_Node_setCamera = cpp.Lib.load("gameplay", "hx_Node_setCamera", 2);
    static var hx_Node_setCollisionObject_Int_Def_Param = cpp.Lib.load("gameplay", "hx_Node_setCollisionObject_Int_Def_Param", 4);
    static var hx_Node_setCollisionObject_Prop = cpp.Lib.load("gameplay", "hx_Node_setCollisionObject_Prop", 2);
    static var hx_Node_setCollisionObject_Str = cpp.Lib.load("gameplay", "hx_Node_setCollisionObject_Str", 2);
    static var hx_Node_setForm = cpp.Lib.load("gameplay", "hx_Node_setForm", 2);
    static var hx_Node_setId = cpp.Lib.load("gameplay", "hx_Node_setId", 2);
    static var hx_Node_setLight = cpp.Lib.load("gameplay", "hx_Node_setLight", 2);
    static var hx_Node_setModel = cpp.Lib.load("gameplay", "hx_Node_setModel", 2);
    static var hx_Node_setParticleEmitter = cpp.Lib.load("gameplay", "hx_Node_setParticleEmitter", 2);
    static var hx_Node_setTag = cpp.Lib.load("gameplay", "hx_Node_setTag", 3);
    static var hx_Node_setTerrain = cpp.Lib.load("gameplay", "hx_Node_setTerrain", 2);
    static var hx_Node_setUserPointer = cpp.Lib.load("gameplay", "hx_Node_setUserPointer", 3);
}
