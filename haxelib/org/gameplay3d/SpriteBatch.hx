...
class SpriteBatch extends GameplayObject
{
    ...
    static var hx_SpriteBatch_static_create_Tex_Eff_Int = NativeInterface.loadMember(SpriteBatch, "static_create_Tex_Eff_Int", 3);
    static var hx_SpriteBatch_static_create_Str_Eff_Int = NativeInterface.loadMember(SpriteBatch, "static_create_Str_Eff_Int", 3);
    static var hx_SpriteBatch_draw_RctX2_V4 = NativeInterface.loadMember(SpriteBatch, "draw_RctX2_V4", 4);
    static var hx_SpriteBatch_draw_V3_Rct_V2_V4 = NativeInterface.loadMember(SpriteBatch, "draw_V3_Rct_V2_V4", 5);
    static var hx_SpriteBatch_draw_V3_Rct_V2_V4_V2_Flt = NativeInterface.loadMember(SpriteBatch, "draw_V3_Rct_V2_V4_V2_Flt", -1);
    static var hx_SpriteBatch_draw_V3_FltX6_V4_V2_Flt_Bool = NativeInterface.loadMember(SpriteBatch, "draw_V3_FltX6_V4_V2_Flt_Bool", -1);
    static var hx_SpriteBatch_draw_V3X3_FltX6_V4_V2_Flt = NativeInterface.loadMember(SpriteBatch, "draw_V3X3_FltX6_V4_V2_Flt", -1);
    static var hx_SpriteBatch_draw_FltX8_V4 = NativeInterface.loadMember(SpriteBatch, "draw_FltX8_V4", -1);
    static var hx_SpriteBatch_draw_FltX8_V4_Rct = NativeInterface.loadMember(SpriteBatch, "draw_FltX8_V4_Rct", -1);
    static var hx_SpriteBatch_draw_FltX9_V4_Bool = NativeInterface.loadMember(SpriteBatch, "draw_FltX9_V4_Bool", -1);
    static var hx_SpriteBatch_draw_FltX9_V4_V2_Flt_Bool = NativeInterface.loadMember(SpriteBatch, "draw_FltX9_V4_V2_Flt_Bool", -1);
    static var hx_SpriteBatch_finish = NativeInterface.loadMember(SpriteBatch, "finish", 1);
    static var hx_SpriteBatch_getMaterial = NativeInterface.loadMember(SpriteBatch, "getMaterial", 1);
    static var hx_SpriteBatch_getProjectionMatrix = NativeInterface.loadMember(SpriteBatch, "getProjectionMatrix", 1);
    static var hx_SpriteBatch_getSampler = NativeInterface.loadMember(SpriteBatch, "getSampler", 1);
    static var hx_SpriteBatch_getStateBlock = NativeInterface.loadMember(SpriteBatch, "getStateBlock", 1);
    static var hx_SpriteBatch_setProjectionMatrix = NativeInterface.loadMember(SpriteBatch, "setProjectionMatrix", 2);
    static var hx_SpriteBatch_start = NativeInterface.loadMember(SpriteBatch, "start", 1);
}
