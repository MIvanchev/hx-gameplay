...
class Texture_Sampler extends GameplayObject, implements Ref
{
    ...
    static var hx_Texture_Sampler_bind:Dynamic = cpp.Lib.load("gameplay", "hx_Texture_Sampler_bind", 1);
    static var hx_Texture_Sampler_static_create_Tex:Dynamic = cpp.Lib.load("gameplay", "hx_Texture_Sampler_static_create_Tex", 1);
    static var hx_Texture_Sampler_static_create_Str_Bool:Dynamic = cpp.Lib.load("gameplay", "hx_Texture_Sampler_static_create_Str_Bool", 2);
    static var hx_Texture_Sampler_getTexture:Dynamic = cpp.Lib.load("gameplay", "hx_Texture_Sampler_getTexture", 1);
    static var hx_Texture_Sampler_setFilterMode:Dynamic = cpp.Lib.load("gameplay", "hx_Texture_Sampler_setFilterMode", 3);
    static var hx_Texture_Sampler_setWrapMode:Dynamic = cpp.Lib.load("gameplay", "hx_Texture_Sampler_setWrapMode", 3);
}
