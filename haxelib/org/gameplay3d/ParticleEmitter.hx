...
class ParticleEmitter extends GameplayObject, implements Ref
{
    ...
    static var hx_ParticleEmitter_static_create_Prop = cpp.Lib.load("gameplay", "hx_ParticleEmitter_static_create_Prop", 1);
    static var hx_ParticleEmitter_static_create_Str_IntX2 = cpp.Lib.load("gameplay", "hx_ParticleEmitter_static_create_Str_IntX2", 3);
    static var hx_ParticleEmitter_static_create_Str = cpp.Lib.load("gameplay", "hx_ParticleEmitter_static_create_Str", 1);
    static var hx_ParticleEmitter_draw = cpp.Lib.load("gameplay", "hx_ParticleEmitter_draw", 1);
    static var hx_ParticleEmitter_emitOnce = cpp.Lib.load("gameplay", "hx_ParticleEmitter_emitOnce", 2);
    static var hx_ParticleEmitter_getAcceleration = cpp.Lib.load("gameplay", "hx_ParticleEmitter_getAcceleration", 1);
    static var hx_ParticleEmitter_getAccelerationVariance = cpp.Lib.load("gameplay", "hx_ParticleEmitter_getAccelerationVariance", 1);
    static var hx_ParticleEmitter_getColorEnd = cpp.Lib.load("gameplay", "hx_ParticleEmitter_getColorEnd", 1);
    static var hx_ParticleEmitter_getColorEndVariance = cpp.Lib.load("gameplay", "hx_ParticleEmitter_getColorEndVariance", 1);
    static var hx_ParticleEmitter_getColorStart = cpp.Lib.load("gameplay", "hx_ParticleEmitter_getColorStart", 1);
    static var hx_ParticleEmitter_getColorStartVariance = cpp.Lib.load("gameplay", "hx_ParticleEmitter_getColorStartVariance", 1);
    static var hx_ParticleEmitter_getEmissionRate = cpp.Lib.load("gameplay", "hx_ParticleEmitter_getEmissionRate", 1);
    static var hx_ParticleEmitter_getEnergyMax = cpp.Lib.load("gameplay", "hx_ParticleEmitter_getEnergyMax", 1);
    static var hx_ParticleEmitter_getEnergyMin = cpp.Lib.load("gameplay", "hx_ParticleEmitter_getEnergyMin", 1);
    static var hx_ParticleEmitter_getNode = cpp.Lib.load("gameplay", "hx_ParticleEmitter_getNode", 1);
    static var hx_ParticleEmitter_getParticlesCount = cpp.Lib.load("gameplay", "hx_ParticleEmitter_getParticlesCount", 1);
    static var hx_ParticleEmitter_getPosition = cpp.Lib.load("gameplay", "hx_ParticleEmitter_getPosition", 1);
    static var hx_ParticleEmitter_getPositionVariance = cpp.Lib.load("gameplay", "hx_ParticleEmitter_getPositionVariance", 1);
    static var hx_ParticleEmitter_getRotationAxis = cpp.Lib.load("gameplay", "hx_ParticleEmitter_getRotationAxis", 1);
    static var hx_ParticleEmitter_getRotationAxisVariance = cpp.Lib.load("gameplay", "hx_ParticleEmitter_getRotationAxisVariance", 1);
    static var hx_ParticleEmitter_getRotationPerParticleSpeedMax = cpp.Lib.load("gameplay", "hx_ParticleEmitter_getRotationPerParticleSpeedMax", 1);
    static var hx_ParticleEmitter_getRotationPerParticleSpeedMin = cpp.Lib.load("gameplay", "hx_ParticleEmitter_getRotationPerParticleSpeedMin", 1);
    static var hx_ParticleEmitter_getRotationSpeedMax = cpp.Lib.load("gameplay", "hx_ParticleEmitter_getRotationSpeedMax", 1);
    static var hx_ParticleEmitter_getRotationSpeedMin = cpp.Lib.load("gameplay", "hx_ParticleEmitter_getRotationSpeedMin", 1);
    static var hx_ParticleEmitter_getSizeEndMax = cpp.Lib.load("gameplay", "hx_ParticleEmitter_getSizeEndMax", 1);
    static var hx_ParticleEmitter_getSizeEndMin = cpp.Lib.load("gameplay", "hx_ParticleEmitter_getSizeEndMin", 1);
    static var hx_ParticleEmitter_getSizeStartMax = cpp.Lib.load("gameplay", "hx_ParticleEmitter_getSizeStartMax", 1);
    static var hx_ParticleEmitter_getSizeStartMin = cpp.Lib.load("gameplay", "hx_ParticleEmitter_getSizeStartMin", 1);
    static var hx_ParticleEmitter_getSpriteFrameDuration = cpp.Lib.load("gameplay", "hx_ParticleEmitter_getSpriteFrameDuration", 1);
    static var hx_ParticleEmitter_getSpriteFrameRandomOffset = cpp.Lib.load("gameplay", "hx_ParticleEmitter_getSpriteFrameRandomOffset", 1);
    static var hx_ParticleEmitter_static_getTextureBlendingFromString = cpp.Lib.load("gameplay", "hx_ParticleEmitter_static_getTextureBlendingFromString", 1);
    static var hx_ParticleEmitter_getVelocity = cpp.Lib.load("gameplay", "hx_ParticleEmitter_getVelocity", 1);
    static var hx_ParticleEmitter_getVelocityVariance = cpp.Lib.load("gameplay", "hx_ParticleEmitter_getVelocityVariance", 1);
    static var hx_ParticleEmitter_isActive = cpp.Lib.load("gameplay", "hx_ParticleEmitter_isActive", 1);
    static var hx_ParticleEmitter_isEllipsoid = cpp.Lib.load("gameplay", "hx_ParticleEmitter_isEllipsoid", 1);
    static var hx_ParticleEmitter_isSpriteAnimated = cpp.Lib.load("gameplay", "hx_ParticleEmitter_isSpriteAnimated", 1);
    static var hx_ParticleEmitter_isSpriteLooped = cpp.Lib.load("gameplay", "hx_ParticleEmitter_isSpriteLooped", 1);
    static var hx_ParticleEmitter_isStarted = cpp.Lib.load("gameplay", "hx_ParticleEmitter_isStarted", 1);
    static var hx_ParticleEmitter_setAcceleration = cpp.Lib.load("gameplay", "hx_ParticleEmitter_setAcceleration", 3);
    static var hx_ParticleEmitter_setColor = cpp.Lib.load("gameplay", "hx_ParticleEmitter_setColor", 5);
    static var hx_ParticleEmitter_setEllipsoid = cpp.Lib.load("gameplay", "hx_ParticleEmitter_setEllipsoid", 2);
    static var hx_ParticleEmitter_setEmissionRate = cpp.Lib.load("gameplay", "hx_ParticleEmitter_setEmissionRate", 2);
    static var hx_ParticleEmitter_setEnergy = cpp.Lib.load("gameplay", "hx_ParticleEmitter_setEnergy", 3);
    static var hx_ParticleEmitter_setOrbit = cpp.Lib.load("gameplay", "hx_ParticleEmitter_setOrbit", 4);
    static var hx_ParticleEmitter_setPosition = cpp.Lib.load("gameplay", "hx_ParticleEmitter_setPosition", 3);
    static var hx_ParticleEmitter_setRotation = cpp.Lib.load("gameplay", "hx_ParticleEmitter_setRotation", 5);
    static var hx_ParticleEmitter_setRotationPerParticle = cpp.Lib.load("gameplay", "hx_ParticleEmitter_setRotationPerParticle", 3);
    static var hx_ParticleEmitter_setSize = cpp.Lib.load("gameplay", "hx_ParticleEmitter_setSize", 5);
    static var hx_ParticleEmitter_setSpriteAnimated = cpp.Lib.load("gameplay", "hx_ParticleEmitter_setSpriteAnimated", 2);
    static var hx_ParticleEmitter_setSpriteFrameCoords_Int_ArrRct = cpp.Lib.load("gameplay", "hx_ParticleEmitter_setSpriteFrameCoords_Int_ArrRct", 3);
    static var hx_ParticleEmitter_setSpriteFrameCoords_IntX3 = cpp.Lib.load("gameplay", "hx_ParticleEmitter_setSpriteFrameCoords_IntX3", 4);
    static var hx_ParticleEmitter_setSpriteFrameDuration = cpp.Lib.load("gameplay", "hx_ParticleEmitter_setSpriteFrameDuration", 2);
    static var hx_ParticleEmitter_setSpriteFrameRandomOffset = cpp.Lib.load("gameplay", "hx_ParticleEmitter_setSpriteFrameRandomOffset", 2);
    static var hx_ParticleEmitter_setSpriteLooped = cpp.Lib.load("gameplay", "hx_ParticleEmitter_setSpriteLooped", 2);
    static var hx_ParticleEmitter_setSpriteTexCoords = cpp.Lib.load("gameplay", "hx_ParticleEmitter_setSpriteTexCoords", 3);
    static var hx_ParticleEmitter_setTextureBlending = cpp.Lib.load("gameplay", "hx_ParticleEmitter_setTextureBlending", 2);
    static var hx_ParticleEmitter_setVelocity = cpp.Lib.load("gameplay", "hx_ParticleEmitter_setVelocity", 3);
    static var hx_ParticleEmitter_start = cpp.Lib.load("gameplay", "hx_ParticleEmitter_start", 1);
    static var hx_ParticleEmitter_stop = cpp.Lib.load("gameplay", "hx_ParticleEmitter_stop", 1);
    static var hx_ParticleEmitter_update = cpp.Lib.load("gameplay", "hx_ParticleEmitter_update", 2);
}
