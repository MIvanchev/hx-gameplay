...
class Vector3 extends GameplayObject, implements IVector3
{
    ...
    static var hx_Vector3_Construct = cpp.Lib.load("gameplay", "hx_Vector3_Construct", 0);
    static var hx_Vector3_Construct_V3 = cpp.Lib.load("gameplay", "hx_Vector3_Construct_V3", 1);
    static var hx_Vector3_Construct_V3X2 = cpp.Lib.load("gameplay", "hx_Vector3_Construct_V3X2", 2);
    static var hx_Vector3_Construct_ArrFlt = cpp.Lib.load("gameplay", "hx_Vector3_Construct_ArrFlt", 1);
    static var hx_Vector3_Construct_FltX3 = cpp.Lib.load("gameplay", "hx_Vector3_Construct_FltX3", 3);
    static var hx_Vector3_static_add = cpp.Lib.load("gameplay", "hx_Vector3_static_add", 3);
    static var hx_Vector3_add = cpp.Lib.load("gameplay", "hx_Vector3_add", 2);
    static var hx_Vector3_static_angle = cpp.Lib.load("gameplay", "hx_Vector3_static_angle", 2);
    static var hx_Vector3_static_clamp = cpp.Lib.load("gameplay", "hx_Vector3_static_clamp", 4);
    static var hx_Vector3_clamp = cpp.Lib.load("gameplay", "hx_Vector3_clamp", 3);
    static var hx_Vector3_static_cross = cpp.Lib.load("gameplay", "hx_Vector3_static_cross", 3);
    static var hx_Vector3_cross = cpp.Lib.load("gameplay", "hx_Vector3_cross", 2);
    static var hx_Vector3_distance = cpp.Lib.load("gameplay", "hx_Vector3_distance", 2);
    static var hx_Vector3_distanceSquared = cpp.Lib.load("gameplay", "hx_Vector3_distanceSquared", 2);
    static var hx_Vector3_dot = cpp.Lib.load("gameplay", "hx_Vector3_dot", 2);
    static var hx_Vector3_static_dot = cpp.Lib.load("gameplay", "hx_Vector3_static_dot", 2);
    static var hx_Vector3_static_fromColor = cpp.Lib.load("gameplay", "hx_Vector3_static_fromColor", 1);
    static var hx_Vector3_isOne = cpp.Lib.load("gameplay", "hx_Vector3_isOne", 1);
    static var hx_Vector3_isZero = cpp.Lib.load("gameplay", "hx_Vector3_isZero", 1);
    static var hx_Vector3_length = cpp.Lib.load("gameplay", "hx_Vector3_length", 1);
    static var hx_Vector3_lengthSquared = cpp.Lib.load("gameplay", "hx_Vector3_lengthSquared", 1);
    static var hx_Vector3_negate = cpp.Lib.load("gameplay", "hx_Vector3_negate", 1);
    static var hx_Vector3_normalize = cpp.Lib.load("gameplay", "hx_Vector3_normalize", 1);
    static var hx_Vector3_normalize_V3 = cpp.Lib.load("gameplay", "hx_Vector3_normalize_V3", 2);
    static var hx_Vector3_static_one = cpp.Lib.load("gameplay", "hx_Vector3_static_one", 0);
    static var hx_Vector3_scale = cpp.Lib.load("gameplay", "hx_Vector3_scale", 2);
    static var hx_Vector3_set_V3X2 = cpp.Lib.load("gameplay", "hx_Vector3_set_V3X2", 3);
    static var hx_Vector3_set_V3 = cpp.Lib.load("gameplay", "hx_Vector3_set_V3", 2);
    static var hx_Vector3_set_ArrFlt = cpp.Lib.load("gameplay", "hx_Vector3_set_ArrFlt", 2);
    static var hx_Vector3_set_FltX3 = cpp.Lib.load("gameplay", "hx_Vector3_set_FltX3", 4);
    static var hx_Vector3_smooth = cpp.Lib.load("gameplay", "hx_Vector3_smooth", 4);
    static var hx_Vector3_static_subtract = cpp.Lib.load("gameplay", "hx_Vector3_static_subtract", 3);
    static var hx_Vector3_subtract = cpp.Lib.load("gameplay", "hx_Vector3_subtract", 2);
    static var hx_Vector3_static_unitX = cpp.Lib.load("gameplay", "hx_Vector3_static_unitX", 0);
    static var hx_Vector3_static_unitY = cpp.Lib.load("gameplay", "hx_Vector3_static_unitY", 0);
    static var hx_Vector3_static_unitZ = cpp.Lib.load("gameplay", "hx_Vector3_static_unitZ", 0);
    static var hx_Vector3_static_zero = cpp.Lib.load("gameplay", "hx_Vector3_static_zero", 0);
    static var hx_Vector3_property_x_get = cpp.Lib.load("gameplay", "hx_Vector3_property_x_get", 1);
    static var hx_Vector3_property_x_set = cpp.Lib.load("gameplay", "hx_Vector3_property_x_set", 2);
    static var hx_Vector3_property_y_get = cpp.Lib.load("gameplay", "hx_Vector3_property_y_get", 1);
    static var hx_Vector3_property_y_set = cpp.Lib.load("gameplay", "hx_Vector3_property_y_set", 2);
    static var hx_Vector3_property_z_get = cpp.Lib.load("gameplay", "hx_Vector3_property_z_get", 1);
    static var hx_Vector3_property_z_set = cpp.Lib.load("gameplay", "hx_Vector3_property_z_set", 2);
}
