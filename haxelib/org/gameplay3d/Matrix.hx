...
class Matrix extends GameplayObject, implements IMatrix
{
    ...
    static var hx_Matrix_Construct = cpp.Lib.load("gameplay", "hx_Matrix_Construct", 0);
    static var hx_Matrix_Construct_Mat = cpp.Lib.load("gameplay", "hx_Matrix_Construct_Mat", 1);
    static var hx_Matrix_Construct_ArrFlt = cpp.Lib.load("gameplay", "hx_Matrix_Construct_ArrFlt", 1);
    static var hx_Matrix_Construct_FltX16 = cpp.Lib.load("gameplay", "hx_Matrix_Construct_FltX16", -1);
    static var hx_Matrix_static_add = cpp.Lib.load("gameplay", "hx_Matrix_static_add", 3);
    static var hx_Matrix_add_Mat = cpp.Lib.load("gameplay", "hx_Matrix_add_Mat", 2);
    static var hx_Matrix_add_Flt = cpp.Lib.load("gameplay", "hx_Matrix_add_Flt", 2);
    static var hx_Matrix_add_Flt_Mat = cpp.Lib.load("gameplay", "hx_Matrix_add_Flt_Mat", 3);
    static var hx_Matrix_static_createBillboard_V3X3_Mat = cpp.Lib.load("gameplay", "hx_Matrix_static_createBillboard_V3X3_Mat", 4);
    static var hx_Matrix_static_createBillboard_V3X4_Mat = cpp.Lib.load("gameplay", "hx_Matrix_static_createBillboard_V3X4_Mat", 5);
    static var hx_Matrix_static_createLookAt_V3X3_Mat = cpp.Lib.load("gameplay", "hx_Matrix_static_createLookAt_V3X3_Mat", 4);
    static var hx_Matrix_static_createLookAt_FltX9_Mat = cpp.Lib.load("gameplay", "hx_Matrix_static_createLookAt_FltX9_Mat", -1);
    static var hx_Matrix_static_createOrthographic = cpp.Lib.load("gameplay", "hx_Matrix_static_createOrthographic", 5);
    static var hx_Matrix_static_createOrthographicOffCenter = cpp.Lib.load("gameplay", "hx_Matrix_static_createOrthographicOffCenter", -1);
    static var hx_Matrix_static_createPerspective = cpp.Lib.load("gameplay", "hx_Matrix_static_createPerspective", 5);
    static var hx_Matrix_static_createReflection = cpp.Lib.load("gameplay", "hx_Matrix_static_createReflection", 2);
    static var hx_Matrix_static_createRotation_Qtrn_Mat = cpp.Lib.load("gameplay", "hx_Matrix_static_createRotation_Qtrn_Mat", 2);
    static var hx_Matrix_static_createRotation_V3_Flt_Mat = cpp.Lib.load("gameplay", "hx_Matrix_static_createRotation_V3_Flt_Mat", 3);
    static var hx_Matrix_static_createRotationX = cpp.Lib.load("gameplay", "hx_Matrix_static_createRotationX", 2);
    static var hx_Matrix_static_createRotationY = cpp.Lib.load("gameplay", "hx_Matrix_static_createRotationY", 2);
    static var hx_Matrix_static_createRotationZ = cpp.Lib.load("gameplay", "hx_Matrix_static_createRotationZ", 2);
    static var hx_Matrix_static_createScale_V3_Mat = cpp.Lib.load("gameplay", "hx_Matrix_static_createScale_V3_Mat", 2);
    static var hx_Matrix_static_createScale_FltX3_Mat = cpp.Lib.load("gameplay", "hx_Matrix_static_createScale_FltX3_Mat", 4);
    static var hx_Matrix_static_createTranslation_V3_Mat = cpp.Lib.load("gameplay", "hx_Matrix_static_createTranslation_V3_Mat", 2);
    static var hx_Matrix_static_createTranslation_FltX3_Mat = cpp.Lib.load("gameplay", "hx_Matrix_static_createTranslation_FltX3_Mat", 4);
    static var hx_Matrix_decompose = cpp.Lib.load("gameplay", "hx_Matrix_decompose", 4);
    static var hx_Matrix_determinant = cpp.Lib.load("gameplay", "hx_Matrix_determinant", 1);
    static var hx_Matrix_getBackVector = cpp.Lib.load("gameplay", "hx_Matrix_getBackVector", 2);
    static var hx_Matrix_getDownVector = cpp.Lib.load("gameplay", "hx_Matrix_getDownVector", 2);
    static var hx_Matrix_getForwardVector = cpp.Lib.load("gameplay", "hx_Matrix_getForwardVector", 2);
    static var hx_Matrix_getLeftVector = cpp.Lib.load("gameplay", "hx_Matrix_getLeftVector", 2);
    static var hx_Matrix_getRightVector = cpp.Lib.load("gameplay", "hx_Matrix_getRightVector", 2);
    static var hx_Matrix_getRotation = cpp.Lib.load("gameplay", "hx_Matrix_getRotation", 2);
    static var hx_Matrix_getScale = cpp.Lib.load("gameplay", "hx_Matrix_getScale", 2);
    static var hx_Matrix_getTranslation = cpp.Lib.load("gameplay", "hx_Matrix_getTranslation", 2);
    static var hx_Matrix_getUpVector = cpp.Lib.load("gameplay", "hx_Matrix_getUpVector", 2);
    static var hx_Matrix_static_identity = cpp.Lib.load("gameplay", "hx_Matrix_static_identity", 0);
    static var hx_Matrix_invert = cpp.Lib.load("gameplay", "hx_Matrix_invert", 1);
    static var hx_Matrix_invert_Mat = cpp.Lib.load("gameplay", "hx_Matrix_invert_Mat", 2);
    static var hx_Matrix_isIdentity = cpp.Lib.load("gameplay", "hx_Matrix_isIdentity", 1);
    static var hx_Matrix_static_multiply_Mat_Flt_Mat = cpp.Lib.load("gameplay", "hx_Matrix_static_multiply_Mat_Flt_Mat", 3);
    static var hx_Matrix_static_multiply_MatX3 = cpp.Lib.load("gameplay", "hx_Matrix_static_multiply_MatX3", 3);
    static var hx_Matrix_multiply_Mat = cpp.Lib.load("gameplay", "hx_Matrix_multiply_Mat", 2);
    static var hx_Matrix_multiply_Flt = cpp.Lib.load("gameplay", "hx_Matrix_multiply_Flt", 2);
    static var hx_Matrix_multiply_Flt_Mat = cpp.Lib.load("gameplay", "hx_Matrix_multiply_Flt_Mat", 3);
    static var hx_Matrix_negate = cpp.Lib.load("gameplay", "hx_Matrix_negate", 1);
    static var hx_Matrix_negate_Mat = cpp.Lib.load("gameplay", "hx_Matrix_negate_Mat", 2);
    static var hx_Matrix_rotate_Qtrn = cpp.Lib.load("gameplay", "hx_Matrix_rotate_Qtrn", 2);
    static var hx_Matrix_rotate_Qtrn_Mat = cpp.Lib.load("gameplay", "hx_Matrix_rotate_Qtrn_Mat", 3);
    static var hx_Matrix_rotate_V3_Flt = cpp.Lib.load("gameplay", "hx_Matrix_rotate_V3_Flt", 3);
    static var hx_Matrix_rotate_V3_Flt_Mat = cpp.Lib.load("gameplay", "hx_Matrix_rotate_V3_Flt_Mat", 4);
    static var hx_Matrix_rotateX_Flt = cpp.Lib.load("gameplay", "hx_Matrix_rotateX_Flt", 2);
    static var hx_Matrix_rotateX_Flt_Mat = cpp.Lib.load("gameplay", "hx_Matrix_rotateX_Flt_Mat", 3);
    static var hx_Matrix_rotateY_Flt = cpp.Lib.load("gameplay", "hx_Matrix_rotateY_Flt", 2);
    static var hx_Matrix_rotateY_Flt_Mat = cpp.Lib.load("gameplay", "hx_Matrix_rotateY_Flt_Mat", 3);
    static var hx_Matrix_rotateZ_Flt = cpp.Lib.load("gameplay", "hx_Matrix_rotateZ_Flt", 2);
    static var hx_Matrix_rotateZ_Flt_Mat = cpp.Lib.load("gameplay", "hx_Matrix_rotateZ_Flt_Mat", 3);
    static var hx_Matrix_scale_V3 = cpp.Lib.load("gameplay", "hx_Matrix_scale_V3", 2);
    static var hx_Matrix_scale_V3_Mat = cpp.Lib.load("gameplay", "hx_Matrix_scale_V3_Mat", 3);
    static var hx_Matrix_scale_Flt = cpp.Lib.load("gameplay", "hx_Matrix_scale_Flt", 2);
    static var hx_Matrix_scale_Flt_Mat = cpp.Lib.load("gameplay", "hx_Matrix_scale_Flt_Mat", 3);
    static var hx_Matrix_scale_FltX3 = cpp.Lib.load("gameplay", "hx_Matrix_scale_FltX3", 4);
    static var hx_Matrix_scale_FltX3_Mat = cpp.Lib.load("gameplay", "hx_Matrix_scale_FltX3_Mat", 5);
    static var hx_Matrix_set_Mat = cpp.Lib.load("gameplay", "hx_Matrix_set_Mat", 2);
    static var hx_Matrix_set_ArrFlt = cpp.Lib.load("gameplay", "hx_Matrix_set_ArrFlt", 2);
    static var hx_Matrix_set_FltX16 = cpp.Lib.load("gameplay", "hx_Matrix_set_FltX16", -1);
    static var hx_Matrix_setIdentity = cpp.Lib.load("gameplay", "hx_Matrix_setIdentity", 1);
    static var hx_Matrix_setZero = cpp.Lib.load("gameplay", "hx_Matrix_setZero", 1);
    static var hx_Matrix_static_subtract = cpp.Lib.load("gameplay", "hx_Matrix_static_subtract", 3);
    static var hx_Matrix_subtract = cpp.Lib.load("gameplay", "hx_Matrix_subtract", 2);
    static var hx_Matrix_transformPoint_V3 = cpp.Lib.load("gameplay", "hx_Matrix_transformPoint_V3", 2);
    static var hx_Matrix_transformPoint_V3X2 = cpp.Lib.load("gameplay", "hx_Matrix_transformPoint_V3X2", 3);
    static var hx_Matrix_transformVector_V3 = cpp.Lib.load("gameplay", "hx_Matrix_transformVector_V3", 2);
    static var hx_Matrix_transformVector_V4 = cpp.Lib.load("gameplay", "hx_Matrix_transformVector_V4", 2);
    static var hx_Matrix_transformVector_V3X2 = cpp.Lib.load("gameplay", "hx_Matrix_transformVector_V3X2", 3);
    static var hx_Matrix_transformVector_V4X2 = cpp.Lib.load("gameplay", "hx_Matrix_transformVector_V4X2", 3);
    static var hx_Matrix_transformVector_FltX4_V3 = cpp.Lib.load("gameplay", "hx_Matrix_transformVector_FltX4_V3", -1);
    static var hx_Matrix_translate_V3 = cpp.Lib.load("gameplay", "hx_Matrix_translate_V3", 2);
    static var hx_Matrix_translate_V3_Mat = cpp.Lib.load("gameplay", "hx_Matrix_translate_V3_Mat", 3);
    static var hx_Matrix_translate_FltX3 = cpp.Lib.load("gameplay", "hx_Matrix_translate_FltX3", 4);
    static var hx_Matrix_translate_FltX3_Mat = cpp.Lib.load("gameplay", "hx_Matrix_translate_FltX3_Mat", 5);
    static var hx_Matrix_transpose = cpp.Lib.load("gameplay", "hx_Matrix_transpose", 1);
    static var hx_Matrix_transpose_Mat = cpp.Lib.load("gameplay", "hx_Matrix_transpose_Mat", 2);
    static var hx_Matrix_static_zero = cpp.Lib.load("gameplay", "hx_Matrix_static_zero", 0);
    static var hx_Matrix_property_m_get = cpp.Lib.load("gameplay", "hx_Matrix_property_m_get", 1);
}
