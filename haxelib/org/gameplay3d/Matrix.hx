...
class Matrix extends GameplayObject, implements IMatrix
{
    ...
    static var hx_Matrix_Construct = NativeInterface.loadMember(Matrix, "Construct", 0);
    static var hx_Matrix_Construct_Mat = NativeInterface.loadMember(Matrix, "Construct_Mat", 1);
    static var hx_Matrix_Construct_ArrFlt = NativeInterface.loadMember(Matrix, "Construct_ArrFlt", 1);
    static var hx_Matrix_Construct_FltX16 = NativeInterface.loadMember(Matrix, "Construct_FltX16", -1);
    static var hx_Matrix_static_add = NativeInterface.loadMember(Matrix, "static_add", 3);
    static var hx_Matrix_add_Mat = NativeInterface.loadMember(Matrix, "add_Mat", 2);
    static var hx_Matrix_add_Flt = NativeInterface.loadMember(Matrix, "add_Flt", 2);
    static var hx_Matrix_add_Flt_Mat = NativeInterface.loadMember(Matrix, "add_Flt_Mat", 3);
    static var hx_Matrix_static_createBillboard_V3X3_Mat = NativeInterface.loadMember(Matrix, "static_createBillboard_V3X3_Mat", 4);
    static var hx_Matrix_static_createBillboard_V3X4_Mat = NativeInterface.loadMember(Matrix, "static_createBillboard_V3X4_Mat", 5);
    static var hx_Matrix_static_createLookAt_V3X3_Mat = NativeInterface.loadMember(Matrix, "static_createLookAt_V3X3_Mat", 4);
    static var hx_Matrix_static_createLookAt_FltX9_Mat = NativeInterface.loadMember(Matrix, "static_createLookAt_FltX9_Mat", -1);
    static var hx_Matrix_static_createOrthographic = NativeInterface.loadMember(Matrix, "static_createOrthographic", 5);
    static var hx_Matrix_static_createOrthographicOffCenter = NativeInterface.loadMember(Matrix, "static_createOrthographicOffCenter", -1);
    static var hx_Matrix_static_createPerspective = NativeInterface.loadMember(Matrix, "static_createPerspective", 5);
    static var hx_Matrix_static_createReflection = NativeInterface.loadMember(Matrix, "static_createReflection", 2);
    static var hx_Matrix_static_createRotation_Qtrn_Mat = NativeInterface.loadMember(Matrix, "static_createRotation_Qtrn_Mat", 2);
    static var hx_Matrix_static_createRotation_V3_Flt_Mat = NativeInterface.loadMember(Matrix, "static_createRotation_V3_Flt_Mat", 3);
    static var hx_Matrix_static_createRotationX = NativeInterface.loadMember(Matrix, "static_createRotationX", 2);
    static var hx_Matrix_static_createRotationY = NativeInterface.loadMember(Matrix, "static_createRotationY", 2);
    static var hx_Matrix_static_createRotationZ = NativeInterface.loadMember(Matrix, "static_createRotationZ", 2);
    static var hx_Matrix_static_createScale_V3_Mat = NativeInterface.loadMember(Matrix, "static_createScale_V3_Mat", 2);
    static var hx_Matrix_static_createScale_FltX3_Mat = NativeInterface.loadMember(Matrix, "static_createScale_FltX3_Mat", 4);
    static var hx_Matrix_static_createTranslation_V3_Mat = NativeInterface.loadMember(Matrix, "static_createTranslation_V3_Mat", 2);
    static var hx_Matrix_static_createTranslation_FltX3_Mat = NativeInterface.loadMember(Matrix, "static_createTranslation_FltX3_Mat", 4);
    static var hx_Matrix_decompose = NativeInterface.loadMember(Matrix, "decompose", 4);
    static var hx_Matrix_determinant = NativeInterface.loadMember(Matrix, "determinant", 1);
    static var hx_Matrix_getBackVector = NativeInterface.loadMember(Matrix, "getBackVector", 2);
    static var hx_Matrix_getDownVector = NativeInterface.loadMember(Matrix, "getDownVector", 2);
    static var hx_Matrix_getForwardVector = NativeInterface.loadMember(Matrix, "getForwardVector", 2);
    static var hx_Matrix_getLeftVector = NativeInterface.loadMember(Matrix, "getLeftVector", 2);
    static var hx_Matrix_getRightVector = NativeInterface.loadMember(Matrix, "getRightVector", 2);
    static var hx_Matrix_getRotation = NativeInterface.loadMember(Matrix, "getRotation", 2);
    static var hx_Matrix_getScale = NativeInterface.loadMember(Matrix, "getScale", 2);
    static var hx_Matrix_getTranslation = NativeInterface.loadMember(Matrix, "getTranslation", 2);
    static var hx_Matrix_getUpVector = NativeInterface.loadMember(Matrix, "getUpVector", 2);
    static var hx_Matrix_static_identity = NativeInterface.loadMember(Matrix, "static_identity", 0);
    static var hx_Matrix_invert = NativeInterface.loadMember(Matrix, "invert", 1);
    static var hx_Matrix_invert_Mat = NativeInterface.loadMember(Matrix, "invert_Mat", 2);
    static var hx_Matrix_isIdentity = NativeInterface.loadMember(Matrix, "isIdentity", 1);
    static var hx_Matrix_static_multiply_Mat_Flt_Mat = NativeInterface.loadMember(Matrix, "static_multiply_Mat_Flt_Mat", 3);
    static var hx_Matrix_static_multiply_MatX3 = NativeInterface.loadMember(Matrix, "static_multiply_MatX3", 3);
    static var hx_Matrix_multiply_Mat = NativeInterface.loadMember(Matrix, "multiply_Mat", 2);
    static var hx_Matrix_multiply_Flt = NativeInterface.loadMember(Matrix, "multiply_Flt", 2);
    static var hx_Matrix_multiply_Flt_Mat = NativeInterface.loadMember(Matrix, "multiply_Flt_Mat", 3);
    static var hx_Matrix_negate = NativeInterface.loadMember(Matrix, "negate", 1);
    static var hx_Matrix_negate_Mat = NativeInterface.loadMember(Matrix, "negate_Mat", 2);
    static var hx_Matrix_rotate_Qtrn = NativeInterface.loadMember(Matrix, "rotate_Qtrn", 2);
    static var hx_Matrix_rotate_Qtrn_Mat = NativeInterface.loadMember(Matrix, "rotate_Qtrn_Mat", 3);
    static var hx_Matrix_rotate_V3_Flt = NativeInterface.loadMember(Matrix, "rotate_V3_Flt", 3);
    static var hx_Matrix_rotate_V3_Flt_Mat = NativeInterface.loadMember(Matrix, "rotate_V3_Flt_Mat", 4);
    static var hx_Matrix_rotateX_Flt = NativeInterface.loadMember(Matrix, "rotateX_Flt", 2);
    static var hx_Matrix_rotateX_Flt_Mat = NativeInterface.loadMember(Matrix, "rotateX_Flt_Mat", 3);
    static var hx_Matrix_rotateY_Flt = NativeInterface.loadMember(Matrix, "rotateY_Flt", 2);
    static var hx_Matrix_rotateY_Flt_Mat = NativeInterface.loadMember(Matrix, "rotateY_Flt_Mat", 3);
    static var hx_Matrix_rotateZ_Flt = NativeInterface.loadMember(Matrix, "rotateZ_Flt", 2);
    static var hx_Matrix_rotateZ_Flt_Mat = NativeInterface.loadMember(Matrix, "rotateZ_Flt_Mat", 3);
    static var hx_Matrix_scale_V3 = NativeInterface.loadMember(Matrix, "scale_V3", 2);
    static var hx_Matrix_scale_V3_Mat = NativeInterface.loadMember(Matrix, "scale_V3_Mat", 3);
    static var hx_Matrix_scale_Flt = NativeInterface.loadMember(Matrix, "scale_Flt", 2);
    static var hx_Matrix_scale_Flt_Mat = NativeInterface.loadMember(Matrix, "scale_Flt_Mat", 3);
    static var hx_Matrix_scale_FltX3 = NativeInterface.loadMember(Matrix, "scale_FltX3", 4);
    static var hx_Matrix_scale_FltX3_Mat = NativeInterface.loadMember(Matrix, "scale_FltX3_Mat", 5);
    static var hx_Matrix_set_Mat = NativeInterface.loadMember(Matrix, "set_Mat", 2);
    static var hx_Matrix_set_ArrFlt = NativeInterface.loadMember(Matrix, "set_ArrFlt", 2);
    static var hx_Matrix_set_FltX16 = NativeInterface.loadMember(Matrix, "set_FltX16", -1);
    static var hx_Matrix_setIdentity = NativeInterface.loadMember(Matrix, "setIdentity", 1);
    static var hx_Matrix_setZero = NativeInterface.loadMember(Matrix, "setZero", 1);
    static var hx_Matrix_static_subtract = NativeInterface.loadMember(Matrix, "static_subtract", 3);
    static var hx_Matrix_subtract = NativeInterface.loadMember(Matrix, "subtract", 2);
    static var hx_Matrix_transformPoint_V3 = NativeInterface.loadMember(Matrix, "transformPoint_V3", 2);
    static var hx_Matrix_transformPoint_V3X2 = NativeInterface.loadMember(Matrix, "transformPoint_V3X2", 3);
    static var hx_Matrix_transformVector_V3 = NativeInterface.loadMember(Matrix, "transformVector_V3", 2);
    static var hx_Matrix_transformVector_V4 = NativeInterface.loadMember(Matrix, "transformVector_V4", 2);
    static var hx_Matrix_transformVector_V3X2 = NativeInterface.loadMember(Matrix, "transformVector_V3X2", 3);
    static var hx_Matrix_transformVector_V4X2 = NativeInterface.loadMember(Matrix, "transformVector_V4X2", 3);
    static var hx_Matrix_transformVector_FltX4_V3 = NativeInterface.loadMember(Matrix, "transformVector_FltX4_V3", -1);
    static var hx_Matrix_translate_V3 = NativeInterface.loadMember(Matrix, "translate_V3", 2);
    static var hx_Matrix_translate_V3_Mat = NativeInterface.loadMember(Matrix, "translate_V3_Mat", 3);
    static var hx_Matrix_translate_FltX3 = NativeInterface.loadMember(Matrix, "translate_FltX3", 4);
    static var hx_Matrix_translate_FltX3_Mat = NativeInterface.loadMember(Matrix, "translate_FltX3_Mat", 5);
    static var hx_Matrix_transpose = NativeInterface.loadMember(Matrix, "transpose", 1);
    static var hx_Matrix_transpose_Mat = NativeInterface.loadMember(Matrix, "transpose_Mat", 2);
    static var hx_Matrix_static_zero = NativeInterface.loadMember(Matrix, "static_zero", 0);
    static var hx_Matrix_property_m_get = NativeInterface.loadMember(Matrix, "property_m_get", 1);
}
