...
class Quaternion extends GameplayObject, implements IQuaternion
{
    ...
    static var hx_Quaternion_Construct = cpp.Lib.load("gameplay", "hx_Quaternion_Construct", 0);
    static var hx_Quaternion_Construct_Mat = cpp.Lib.load("gameplay", "hx_Quaternion_Construct_Mat", 1);
    static var hx_Quaternion_Construct_Qtrn = cpp.Lib.load("gameplay", "hx_Quaternion_Construct_Qtrn", 1);
    static var hx_Quaternion_Construct_V3_Flt = cpp.Lib.load("gameplay", "hx_Quaternion_Construct_V3_Flt", 2);
    static var hx_Quaternion_Construct_FltX4 = cpp.Lib.load("gameplay", "hx_Quaternion_Construct_FltX4", 4);
    static var hx_Quaternion_Construct_ArrFlt = cpp.Lib.load("gameplay", "hx_Quaternion_Construct_ArrFlt", 1);
    static var hx_Quaternion_conjugate = cpp.Lib.load("gameplay", "hx_Quaternion_conjugate", 1);
    static var hx_Quaternion_conjugate_Qtrn = cpp.Lib.load("gameplay", "hx_Quaternion_conjugate_Qtrn", 2);
    static var hx_Quaternion_static_createFromAxisAngle = cpp.Lib.load("gameplay", "hx_Quaternion_static_createFromAxisAngle", 3);
    static var hx_Quaternion_static_createFromRotationMatrix = cpp.Lib.load("gameplay", "hx_Quaternion_static_createFromRotationMatrix", 2);
    static var hx_Quaternion_static_identity = cpp.Lib.load("gameplay", "hx_Quaternion_static_identity", 0);
    static var hx_Quaternion_inverse = cpp.Lib.load("gameplay", "hx_Quaternion_inverse", 1);
    static var hx_Quaternion_inverse_Qtrn = cpp.Lib.load("gameplay", "hx_Quaternion_inverse_Qtrn", 2);
    static var hx_Quaternion_isIdentity = cpp.Lib.load("gameplay", "hx_Quaternion_isIdentity", 1);
    static var hx_Quaternion_isZero = cpp.Lib.load("gameplay", "hx_Quaternion_isZero", 1);
    static var hx_Quaternion_static_lerp = cpp.Lib.load("gameplay", "hx_Quaternion_static_lerp", 4);
    static var hx_Quaternion_static_multiply = cpp.Lib.load("gameplay", "hx_Quaternion_static_multiply", 3);
    static var hx_Quaternion_multiply = cpp.Lib.load("gameplay", "hx_Quaternion_multiply", 2);
    static var hx_Quaternion_normalize = cpp.Lib.load("gameplay", "hx_Quaternion_normalize", 1);
    static var hx_Quaternion_normalize_Qtrn = cpp.Lib.load("gameplay", "hx_Quaternion_normalize_Qtrn", 2);
    static var hx_Quaternion_set_Mat = cpp.Lib.load("gameplay", "hx_Quaternion_set_Mat", 2);
    static var hx_Quaternion_set_Qtrn = cpp.Lib.load("gameplay", "hx_Quaternion_set_Qtrn", 2);
    static var hx_Quaternion_set_V3_Flt = cpp.Lib.load("gameplay", "hx_Quaternion_set_V3_Flt", 3);
    static var hx_Quaternion_set_FltX4 = cpp.Lib.load("gameplay", "hx_Quaternion_set_FltX4", 5);
    static var hx_Quaternion_set_ArrFlt = cpp.Lib.load("gameplay", "hx_Quaternion_set_ArrFlt", 2);
    static var hx_Quaternion_setIdentity = cpp.Lib.load("gameplay", "hx_Quaternion_setIdentity", 1);
    static var hx_Quaternion_static_slerp = cpp.Lib.load("gameplay", "hx_Quaternion_static_slerp", 4);
    static var hx_Quaternion_static_squad = cpp.Lib.load("gameplay", "hx_Quaternion_static_squad", -1);
    static var hx_Quaternion_toAxisAngle = cpp.Lib.load("gameplay", "hx_Quaternion_toAxisAngle", 2);
    static var hx_Quaternion_static_zero = cpp.Lib.load("gameplay", "hx_Quaternion_static_zero", 0);
    static var hx_Quaternion_property_w_get = cpp.Lib.load("gameplay", "hx_Quaternion_property_w_get", 1);
    static var hx_Quaternion_property_w_set = cpp.Lib.load("gameplay", "hx_Quaternion_property_w_set", 2);
    static var hx_Quaternion_property_x_get = cpp.Lib.load("gameplay", "hx_Quaternion_property_x_get", 1);
    static var hx_Quaternion_property_x_set = cpp.Lib.load("gameplay", "hx_Quaternion_property_x_set", 2);
    static var hx_Quaternion_property_y_get = cpp.Lib.load("gameplay", "hx_Quaternion_property_y_get", 1);
    static var hx_Quaternion_property_y_set = cpp.Lib.load("gameplay", "hx_Quaternion_property_y_set", 2);
    static var hx_Quaternion_property_z_get = cpp.Lib.load("gameplay", "hx_Quaternion_property_z_get", 1);
    static var hx_Quaternion_property_z_set = cpp.Lib.load("gameplay", "hx_Quaternion_property_z_set", 2);
}
